...
November 2024 | [Draft](../assets/papers/baek_beet.pdf) | [SSRN](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4859645)

    <details>
        <summary style="margin-top: -1.3em; cursor: pointer; color: #007BFF;">Abstract</summary>
        <p class="notice" style="margin-top:0 !important">
            This paper investigates the agglomeration spillovers from beet sugar factories, which attracted manufacturing jobs near farmlands and were strategically supported by the U.S. government as an industrial policy. To estimate the effects of plant openings, I identify runner-up locations for beet sugar plants from a historical trade journal and find that these plant openings had large and long-lasting effects on population and manufacturing activities over one hundred years. The local jobs multiplier was significantly larger in less populated areas, suggesting that low congestion during the early period of frontier settlement enabled a substantial impact. The agglomeration spillovers benefited industries not only directly linked through input-output linkages but also extended to broader, less related industries outside the production chain of agricultural processing. These findings suggest that modest, well-targeted place-based policies can have transformative impacts on local economies, particularly in the early stages of economic development when populations are not yet fully settled.
        </p>
    </details>
