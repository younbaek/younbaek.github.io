...
- "Do Venture Capitalists Venture?" [Draft coming soon]
    ...
    <details>
        ...
        <p class="notice" style="margin-top:0 !important">
            Innovators learn from others, but they may also follow others simply because others do. This paper asks whether the resulting convergence in venture capital reflects useful learning or costly herding. I measure VCs' investment similarity as the semantic proximity between textual descriptions of a focal startup and other recently funded startups. Then I investigate the influence of peer investors active in the same geography–industry cell, using variation in their investment behavior outside the focal geography and industry. I probe the identifying assumption using timing tests, residual-comovement tests across predetermined investor links, random-shift placebos, and stricter market exclusions. Peer-induced similarity lowers VC investment returns and worsens startups' revenue growth and innovation. I then open up the aggregate instrument into multiple VC investment waves through text anlaysis. The negative return pattern persists among episodes whose origins can be traced to external events unrelated to the focal investment opportunity. Heterogeneity in peers reveals a mismatch between influence and informativeness: investors respond more strongly to network-central peers even though following them predicts worse returns. Imitation creates no offsetting benefits for VCs' other portfolio startups or subsequent investments. While the costs of herding fall on limited partners, VCs who herd more deploy more capital and become more central in future syndication networks.
        </p>
    </details>
...
## Publication
  ...
  - "Industrial Spillovers from Agricultural Processing: Evidence from the Beet Sugar Industry" [[Published version (Aug 2026)](https://www.sciencedirect.com/science/article/pii/S0094119026000549)] [[Draft (April 2026)](../assets/papers/baek_beet.pdf)] [[Replication package](https://www.openicpsr.org/openicpsr/project/248151/version/V1/view)] *Journal of Urban Economics* 
