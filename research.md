...
- "Do Venture Capitalists Venture?" [Draft coming soon]
    ...
    <details>
        ...
        <p class="notice" style="margin-top:0 !important">
            Innovators learn from others, but they may also follow others simply because others do. This paper asks whether the resulting convergence in venture capital reflects useful learning or costly herding. I measure VC's investment similarity using the semantic proximity of startup descriptions and trace thematic waves through the behavior of a VC's peers outside the focal geography and industry. When those peers converge toward similar investment themes elsewhere, VCs follow them, even though the resulting investments earn lower financial returns. The waves also worsen startups' revenue growth, innovation, and follow-on funding. Narrative evidence from individual investment episodes yields the same negative return pattern when the forces behind the waves are unlikely to affect the focal deal other than through imitation. Heterogeneity in peer influence reveals a mismatch between who attracts imitation and who is profitable to follow: investors respond more strongly to network-central peers even though following them predicts worse returns. Imitation creates no offsetting benefits for VCs' other portfolio startups or subsequent investments, yet VCs who herd most deploy more capital and become more central in future syndication networks.
        </p>
    </details>
